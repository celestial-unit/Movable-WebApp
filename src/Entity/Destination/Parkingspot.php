...
private ?\DateTime $freeAfter = null;
...
public function getFreeAfter(): ?\DateTime
{
    return $this->freeAfter;
}

public function setFreeAfter(?\DateTime $freeAfter): self
{
    $this->freeAfter = $freeAfter;
    return $this;
}

private $photo; // Add this property
