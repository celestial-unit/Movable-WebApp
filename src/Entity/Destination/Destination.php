...
class Destination
{
    #[ORM\Id]
    #[ORM\GeneratedValue ]
    #[ORM\Column(name:'id',type: 'integer')] // Changed from string to integer
    private ?int $id = null; // Changed property name to camelCase
