...
class TransportController extends AbstractController
{
    ...
    public function deleteTransport($id, EntityManagerInterface $entityManager): Response
    {
     ...
     // ✅ New route for destination autocomplete
     #[Route('/transport/search-suggestions', name: 'transport_search_suggestions')]
     public function searchSuggestions(Request $request, EntityManagerInterface $entityManager): Response
     {
         ...
         if ($query) {
             $transports = $entityManager->getRepository(Transport::class)
                 ...
                 ->where('t.destination LIKE :query')
