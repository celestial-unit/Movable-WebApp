...
class FrontController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $events = $this->entityManager->getRepository(Event::class)
            ...
            ->setMaxResults(3) // Limit to 3 events for the homepage
            ->getQuery()
            ->getResult();
    ...
    #[Route('/sign-language-translation', name: 'app_sign_language_translation')]
    public function signLanguageTranslation(): Response
    {
        // URL of your Flask/FastAPI service
        $serviceUrl = $this->getParameter('app.sign_language_service_url') ?? 'http://localhost:5000';
        
        // Log service URL for debugging
        $this->logger->info('Using Sign Language Service URL: ' . $serviceUrl);
        
        return $this->render('front/home/sign-language.html.twig', [
            'serviceUrl' => $serviceUrl,
            'pageTitle' => 'Sign Language Gesture Recognition'
        ]);
    }
}
