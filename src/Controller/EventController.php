...
final class EventController extends AbstractController
{
    ...
    {
        // Allow anonymous access but still check if user is admin for UI customization
        $user = $this->getUser();
    ...
    {
        // Require admin authentication for the admin dashboard
    ...
    {
        // Require admin authentication for creating events
        if (!$this->isGranted('ROLE_ADMIN')) {
            return $this->redirectToRoute('app_login');
        }
    ...
    
{
    ...
    {
        // Require admin authentication for editing events
        if (!$this->isGranted('ROLE_ADMIN')) {
            return $this->redirectToRoute('app_login');
        }
    ...
    {
        // Require admin authentication for deleting events
        if (!$this->isGranted('ROLE_ADMIN')) {
            return $this->redirectToRoute('app_login');
        }
