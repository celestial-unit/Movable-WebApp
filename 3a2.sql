...
(1, 'aziz', 'Ghadhoun', 'azizghadhoun1@gmail.com', '$2y$13$5osiQVPXvVbL23kGbBe.i.JvCvy4qB9GU8QM2YCcg/iT4ANYaGUn.', 'ADMIN', '2025-03-05 00:26:08', 0, 0, NULL, NULL, '2025-04-16 20:36:28'),
...
--
ALTER TABLE `agent`
  ADD CONSTRAINT `office_agent_fk` FOREIGN KEY (`office_Id`) REFERENCES `office` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
