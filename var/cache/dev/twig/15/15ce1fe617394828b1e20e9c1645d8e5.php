...
/* registration/emails/verification_email.html.twig */
class __TwigTemplate_7f018d9e27bb611b556d45092d527748 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "registration/emails/verification_email.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "registration/emails/verification_email.html.twig"));
...
<body style=\"background-color: #f5f5f9; font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; -webkit-font-smoothing: antialiased; font-size: 16px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;\">
    <span class=\"preheader\" style=\"color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;\">Verify your email address to activate your Movable account</span>
    <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"body\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f5f5f9; width: 100%;\" width=\"100%\" bgcolor=\"#f5f5f9\">
        ...
        yield ",</p>
                                            <p style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;\">Welcome to Movable! We're excited to have you on board. Please verify your email address to activate your account and get started with our transportation services.</p>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #3f78e0;\" valign=\"top\" align=\"center\" bgcolor=\"#3f78e0\">
                                                                            <a href=\"";
        // line 136
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["verifyUrl"]) || array_key_exists("verifyUrl", $context) ? $context["verifyUrl"] : (function () { throw new RuntimeError('Variable "verifyUrl" does not exist.', 136, $this->source); })()), "html", null, true);
        yield "\" target=\"_blank\" style=\"border: solid 1px #3f78e0; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #3f78e0; border-color: #3f78e0; color: #ffffff;\">Verify your email</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
        ...
        // line 146
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["verifyUrl"]) || array_key_exists("verifyUrl", $context) ? $context["verifyUrl"] : (function () { throw new RuntimeError('Variable "verifyUrl" does not exist.', 146, $this->source); })()), "html", null, true);
        yield "\" style=\"color: #3f78e0; text-decoration: underline;\">";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["verifyUrl"]) || array_key_exists("verifyUrl", $context) ? $context["verifyUrl"] : (function () { throw new RuntimeError('Variable "verifyUrl" does not exist.', 146, $this->source); })()), "html", null, true);
        yield "</a></p>
                                            <p style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;\">If you did not create an account with Movable, please ignore this email or contact our support team if you have concerns.</p>
                                            ...
                                            <p style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;\">The Movable Team</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;\" width=\"100%\">
                            <tr>
                                <td class=\"content-block\" style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #9a9ea6; font-size: 12px; text-align: center;\" valign=\"top\" align=\"center\">
                                    ...
                                    <br> Don't like these emails? <a href=\"#\" style=\"text-decoration: underline; color: #9a9ea6; font-size: 12px; text-align: center;\">Unsubscribe</a>.
                                </td>
                            </tr>
                            <tr>
...
";
    ...
    {
        return "registration/emails/verification_email.html.twig";
    }
    ...
    {
        return array (  231 => 171,  201 => 146,  188 => 136,  175 => 126,  48 => 1,);
    }
                                                        ...
                                                        <td align=\"center\" style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; vertical-align: top; padding: 32px 0;\" valign=\"top\">
                                                            <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;\">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style=\"font-family: 'Public Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #3f78e0;\" valign=\"top\" align=\"center\" bgcolor=\"#3f78e0\">
                                                                            <a href=\"{{ verifyUrl }}\" target=\"_blank\" style=\"border: solid 1px #3f78e0; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #3f78e0; border-color: #3f78e0; color: #ffffff;\">Verify your email</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
...
", "registration/emails/verification_email.html.twig", "C:\\xampp\\Movable-WebApp-integration\\templates\\registration\\emails\\verification_email.html.twig");
    }
}
