 ...
 */
class getRateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RateRepository' shared autowired service.
     *
     * @return \App\Repository\RateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RateRepository.php';

        return $container->privates['App\\Repository\\RateRepository'] = new \App\Repository\RateRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
