...
class getReclamationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\ReclamationController'] = $instance = new \App\Controller\ReclamationController(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->privates['App\\Repository\\ReclamationRepository'] ?? $container->load('getReclamationRepositoryService')));
