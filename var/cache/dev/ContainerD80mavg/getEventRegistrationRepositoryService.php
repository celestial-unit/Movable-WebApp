 ...
 */
class getEventRegistrationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventRegistrationRepository' shared autowired service.
     *
     * @return \App\Repository\EventRegistrationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventRegistrationRepository.php';

        return $container->privates['App\\Repository\\EventRegistrationRepository'] = new \App\Repository\EventRegistrationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
