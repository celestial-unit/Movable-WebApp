...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AgentFormType' => ['privates', 'App\\Form\\AgentFormType', 'getAgentFormTypeService', true],
            'App\\Form\\ChangeRoleType' => ['privates', 'App\\Form\\ChangeRoleType', 'getChangeRoleTypeService', true],
            'App\\Form\\CheckStatusType' => ['privates', 'App\\Form\\CheckStatusType', 'getCheckStatusTypeService', true],
            'App\\Form\\Destination\\DestinationType' => ['privates', 'App\\Form\\Destination\\DestinationType', 'getDestinationTypeService', true],
            'App\\Form\\Destination\\FavoriteType' => ['privates', 'App\\Form\\Destination\\FavoriteType', 'getFavoriteTypeService', true],
            'App\\Form\\Destination\\ParkingspotType' => ['privates', 'App\\Form\\Destination\\ParkingspotType', 'getParkingspotTypeService', true],
            'App\\Form\\DriverType' => ['privates', 'App\\Form\\DriverType', 'getDriverTypeService', true],
            'App\\Form\\EditUserType' => ['privates', 'App\\Form\\EditUserType', 'getEditUserTypeService', true],
            'App\\Form\\EventRegistrationType' => ['privates', 'App\\Form\\EventRegistrationType', 'getEventRegistrationTypeService', true],
            'App\\Form\\EventType' => ['privates', 'App\\Form\\EventType', 'getEventTypeService', true],
            'App\\Form\\Front\\ContactType' => ['privates', 'App\\Form\\Front\\ContactType', 'getContactTypeService', true],
            'App\\Form\\OfficeType' => ['privates', 'App\\Form\\OfficeType', 'getOfficeTypeService', true],
            ...
            'App\\Form\\AgentFormType' => '?',
            'App\\Form\\ChangeRoleType' => '?',
            'App\\Form\\CheckStatusType' => '?',
            'App\\Form\\Destination\\DestinationType' => '?',
            'App\\Form\\Destination\\FavoriteType' => '?',
            'App\\Form\\Destination\\ParkingspotType' => '?',
            'App\\Form\\DriverType' => '?',
            'App\\Form\\EditUserType' => '?',
            'App\\Form\\EventRegistrationType' => '?',
            'App\\Form\\EventType' => '?',
