 ...
 */
final class Version20250407201406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD agent_type VARCHAR(255) NOT NULL, ADD payment_mode VARCHAR(255) NOT NULL, DROP agentType, DROP paymentMode, CHANGE firstName firstName VARCHAR(255) NOT NULL, CHANGE lastName lastName VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE date date DATETIME NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY ticket_ibfk_1');
        $this->addSql('DROP INDEX reservationId ON ticket');
        $this->addSql('ALTER TABLE ticket ADD payment_mode VARCHAR(255) NOT NULL, ADD booking_date DATETIME NOT NULL, DROP reservationId, DROP paymentMode, DROP bookingDate, CHANGE transport transport VARCHAR(255) NOT NULL, CHANGE destination destination VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD agentType VARCHAR(50) NOT NULL, ADD paymentMode VARCHAR(50) NOT NULL, DROP agent_type, DROP payment_mode, CHANGE firstName firstName VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE date date DATE NOT NULL, CHANGE location location VARCHAR(100) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE lastName lastName VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE ticket ADD reservationId INT NOT NULL, ADD paymentMode VARCHAR(50) NOT NULL, ADD bookingDate DATE NOT NULL, DROP payment_mode, DROP booking_date, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE destination destination VARCHAR(100) NOT NULL');
