 ...
 */
final class Version20250413162051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent ADD picture_p VARCHAR(255) NOT NULL, DROP pictureP, CHANGE office_Id office_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD first_name VARCHAR(255) NOT NULL, ADD agent_type VARCHAR(255) NOT NULL, ADD payment_mode VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, ADD destination VARCHAR(255) NOT NULL, ADD transport_id INT DEFAULT NULL, ADD driver_id INT DEFAULT NULL, ADD agent_id INT DEFAULT NULL, ADD destination_relation_id INT DEFAULT NULL, DROP firstName, DROP agentType, DROP paymentMode, DROP lastName, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD CONSTRAINT FK_42C8495517647A60 FOREIGN KEY (destination_relation_id) REFERENCES destination (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_42C8495517647A60 ON reservation (destination_relation_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent ADD pictureP VARCHAR(500) NOT NULL, DROP picture_p, CHANGE office_id office_Id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent ADD CONSTRAINT office_agent_fk FOREIGN KEY (office_Id) REFERENCES office (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation DROP FOREIGN KEY FK_42C8495517647A60
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_42C8495517647A60 ON reservation
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD firstName VARCHAR(255) NOT NULL, ADD agentType VARCHAR(255) NOT NULL, ADD paymentMode VARCHAR(255) NOT NULL, ADD lastName VARCHAR(255) NOT NULL, DROP first_name, DROP agent_type, DROP payment_mode, DROP last_name, DROP destination, DROP transport_id, DROP driver_id, DROP agent_id, DROP destination_relation_id, CHANGE status status VARCHAR(20) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
