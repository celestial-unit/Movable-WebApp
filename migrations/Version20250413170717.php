 ...
 */
final class Version20250413170717 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD firstName VARCHAR(255) NOT NULL, ADD agentType VARCHAR(255) DEFAULT NULL, ADD paymentMode VARCHAR(255) NOT NULL, ADD transport VARCHAR(255) DEFAULT NULL, ADD lastName VARCHAR(255) NOT NULL, DROP first_name, DROP agent_type, DROP payment_mode, DROP last_name, DROP destination, DROP transport_id, DROP driver_id, DROP agent_id, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(20) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
