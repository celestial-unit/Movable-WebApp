 ...
 */
final class Version20250407215759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE firstName firstName VARCHAR(255) NOT NULL, CHANGE lastName lastName VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE date date DATETIME NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE agentType agentType VARCHAR(255) NOT NULL, CHANGE paymentMode paymentMode VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY ticket_ibfk_1');
        $this->addSql('DROP INDEX reservationId ON ticket');
        $this->addSql('ALTER TABLE ticket ADD payment_mode VARCHAR(255) NOT NULL, ADD booking_date DATETIME NOT NULL, ADD reservation_relation_id INT DEFAULT NULL, DROP reservationId, DROP paymentMode, DROP bookingDate, CHANGE transport transport VARCHAR(255) NOT NULL, CHANGE destination destination VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE firstName firstName VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE date date DATE NOT NULL, CHANGE location location VARCHAR(100) NOT NULL, CHANGE agentType agentType VARCHAR(50) NOT NULL, CHANGE paymentMode paymentMode VARCHAR(50) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE lastName lastName VARCHAR(50) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\'');
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA3FE3A4C07');
        $this->addSql('DROP INDEX IDX_97A0ADA3FE3A4C07 ON ticket');
        $this->addSql('ALTER TABLE ticket ADD reservationId INT NOT NULL, ADD paymentMode VARCHAR(50) NOT NULL, ADD bookingDate DATE NOT NULL, DROP payment_mode, DROP booking_date, DROP reservation_relation_id, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE destination destination VARCHAR(100) NOT NULL');
