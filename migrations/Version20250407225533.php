 ...
 */
final class Version20250407225533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD reservation_id INT DEFAULT NULL, DROP reservation_relation_id, CHANGE paymentMode paymentMode VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL, CHANGE destination destination VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD reservation_relation_id INT NOT NULL, DROP reservation_id, CHANGE paymentMode paymentMode VARCHAR(50) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE destination destination VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT ticket_ibfk_1 FOREIGN KEY (reservation_relation_id) REFERENCES reservation (id)');
        $this->addSql('CREATE INDEX reservationId ON ticket (reservation_relation_id)');
    }
}
