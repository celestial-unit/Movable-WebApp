 ...
 */
final class Version20250407200729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD first_name VARCHAR(255) NOT NULL, ADD agent_type VARCHAR(255) NOT NULL, ADD payment_mode VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, DROP firstName, DROP lastName, DROP agentType, DROP paymentMode, CHANGE email email VARCHAR(255) NOT NULL, CHANGE date date DATETIME NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD firstName VARCHAR(50) NOT NULL, ADD lastName VARCHAR(50) NOT NULL, ADD agentType VARCHAR(50) NOT NULL, ADD paymentMode VARCHAR(50) NOT NULL, DROP first_name, DROP agent_type, DROP payment_mode, DROP last_name, CHANGE email email VARCHAR(100) NOT NULL, CHANGE date date DATE NOT NULL, CHANGE location location VARCHAR(100) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL');
