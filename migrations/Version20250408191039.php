 ...
 */
final class Version20250408191039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE reservation_id reservation_id INT DEFAULT NULL, CHANGE paymentMode paymentMode VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL, CHANGE destination destination VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE paymentMode paymentMode VARCHAR(50) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE destination destination VARCHAR(100) NOT NULL, CHANGE reservation_id reservation_id INT NOT NULL');
        $this->addSql('DROP INDEX idx_97a0ada3b83297e7 ON ticket');
        $this->addSql('CREATE INDEX reservationId ON ticket (reservation_id)');
