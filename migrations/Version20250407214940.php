 ...
 */
final class Version20250407214940 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP created_at, DROP updated_at, CHANGE firstName firstName VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE date date DATE NOT NULL, CHANGE location location VARCHAR(100) NOT NULL, CHANGE agentType agentType VARCHAR(50) NOT NULL, CHANGE paymentMode paymentMode VARCHAR(50) NOT NULL, CHANGE transport transport VARCHAR(50) NOT NULL, CHANGE lastName lastName VARCHAR(50) NOT NULL');
