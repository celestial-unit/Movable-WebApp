 ...
 */
final class Version20250414134445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD transport_id INT DEFAULT NULL, ADD driver_id INT DEFAULT NULL, ADD agent_id INT DEFAULT NULL, ADD destination_id INT DEFAULT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE agentType agentType VARCHAR(255) NOT NULL, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD CONSTRAINT FK_42C84955816C6140 FOREIGN KEY (destination_id) REFERENCES destination (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_42C84955816C6140 ON reservation (destination_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955816C6140
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_42C84955816C6140 ON reservation
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation DROP transport_id, DROP driver_id, DROP agent_id, DROP destination_id, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE agentType agentType VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(20) NOT NULL
        SQL);
    }
}
