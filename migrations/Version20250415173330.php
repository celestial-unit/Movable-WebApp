 ...
 */
final class Version20250415173330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD reservation_status VARCHAR(20) NOT NULL, DROP firstName, DROP email, DROP agentType, DROP paymentMode, DROP TransportType, DROP lastName, DROP status, DROP DriverName, DROP driver_id, CHANGE location location VARCHAR(255) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE age user_id INT NOT NULL');
