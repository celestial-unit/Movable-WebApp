 ...
 */
final class Version20250407205420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD status VARCHAR(20) NOT NULL, CHANGE firstName firstName VARCHAR(255) NOT NULL, CHANGE lastName lastName VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE date date DATETIME NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE agentType agentType VARCHAR(255) NOT NULL, CHANGE paymentMode paymentMode VARCHAR(255) NOT NULL, CHANGE transport transport VARCHAR(255) NOT NULL');
