 ...
 */
final class Version20250415172911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_email VARCHAR(255) NOT NULL, DROP firstName, DROP email, DROP agentType, DROP paymentMode, DROP TransportType, DROP age, DROP lastName, DROP DriverName, DROP driver_id, CHANGE location location VARCHAR(255) NOT NULL, CHANGE status status VARCHAR(20) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955550872C FOREIGN KEY (user_email) REFERENCES users (email)');
        ...
        $this->addSql('CREATE INDEX IDX_42C84955550872C ON reservation (user_email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamations ADD CONSTRAINT FK_1CAD6B76A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955550872C');
        ...
        $this->addSql('DROP INDEX IDX_42C84955550872C ON reservation');
        ...
        $this->addSql('ALTER TABLE reservation ADD email VARCHAR(255) NOT NULL, ADD agentType VARCHAR(255) DEFAULT NULL, ADD paymentMode VARCHAR(255) NOT NULL, ADD TransportType VARCHAR(255) DEFAULT NULL, ADD age INT NOT NULL, ADD lastName VARCHAR(255) NOT NULL, ADD DriverName VARCHAR(55) DEFAULT NULL, ADD driver_id INT DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(20) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE user_email firstName VARCHAR(255) NOT NULL');
