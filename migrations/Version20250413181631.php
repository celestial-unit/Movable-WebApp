 ...
 */
final class Version20250413181631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD first_name VARCHAR(255) NOT NULL, ADD transport_type VARCHAR(255) DEFAULT NULL, ADD agent_type VARCHAR(255) NOT NULL, ADD payment_mode VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, ADD destination VARCHAR(255) DEFAULT NULL, ADD transport_id INT DEFAULT NULL, ADD driver_id INT DEFAULT NULL, ADD agent_id INT DEFAULT NULL, DROP firstName, DROP agentType, DROP paymentMode, DROP TransportType, DROP lastName, CHANGE location location VARCHAR(255) NOT NULL, CHANGE status status VARCHAR(255) NOT NULL, CHANGE DriverName driver_name VARCHAR(55) DEFAULT NULL, CHANGE created_at set_created_at DATETIME DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD firstName VARCHAR(255) NOT NULL, ADD agentType VARCHAR(255) DEFAULT NULL, ADD paymentMode VARCHAR(255) NOT NULL, ADD TransportType VARCHAR(255) DEFAULT NULL, ADD lastName VARCHAR(255) NOT NULL, DROP first_name, DROP transport_type, DROP agent_type, DROP payment_mode, DROP last_name, DROP destination, DROP transport_id, DROP driver_id, DROP agent_id, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(20) NOT NULL, CHANGE set_created_at created_at DATETIME DEFAULT NULL, CHANGE driver_name DriverName VARCHAR(55) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
